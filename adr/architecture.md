...
(ADRs 034 and 035 are retired to [`adr/_history/`](_history/); their mechanisms are superseded by [ADR 026](026-tokenomics.md#adr-026-tokenomics) — see [§ Cross-ADR Impact](026-tokenomics.md#cross-adr-impact). Do not link to them from canonical ADRs.)
