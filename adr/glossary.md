...
| **TOKEN** | The concrete governance token: the protocol's native fixed-supply (1B) ERC-20. Used for staking, governance, gauge-boost, and slashing — see [ADR 026](026-tokenomics.md). |
| **USDC** | The concrete payment token. Fixed at deployment; all channel deposits, fee distribution, and the externally-raised pre-seed pool are USDC-denominated — see [ADR 003](003-payments.md), [ADR 026](026-tokenomics.md). |
