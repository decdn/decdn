...
For a **systemically misbehaving body**, `suspendRegionalBody` bars that body from issuing *further* entries, subject to governance ratification within 14 days. It does not retract the entries it already issued — those stay enforceable until removed one by one (see [§ Regional Governance Bodies](#regional-governance-bodies)).
