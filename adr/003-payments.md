...
The `StablePaymentChannel` is the payment-channel contract, handling USDC payment channels. The USDC token address is fixed at deployment as an immutable constructor argument.
