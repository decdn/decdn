...
- [ADR 022 § Content Discovery](022-content-discovery.md#adr-022--content-discovery-at-scale): unchanged. Discovery stays hash-level; range-addressed availability remains deferred. The multi-source scheduler in [ADR 039](039-multi-source-parallel-fetch.md#adr-039-multi-source-parallel-fetch-scheduling-on-cdnclientv1) operates over full holders only and will revisit this when range-addressed discovery lands.
