...
- **Ed25519 signatures** (iroh NodeId keys, used for `ProbeResponse` and `StreamResponse` per [ADR 005](005-protocol.md)) have no EVM precompile. Solidity-based verification costs ~500k–1M gas per signature — economically unviable for routine slashing on the canonical L2 (per [ADR 021](021-l2-chain-selection.md)).
...
| --- | --- | --- | --- |
| RIP-7212 Ed25519 precompile | ~3,000 | Not available | Not deployed on the canonical L2 (per [ADR 021](021-l2-chain-selection.md)) as of 2026-04 |
