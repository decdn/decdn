...
| Max records per node | 1,000,000 | ~2.2 GiB memory at max record size (2 KiB coverage bitmap + ~250 B index overhead per record); typical records carry far smaller bitmaps |
