...
> ADR 010 (multi-token, post-PoC) adds `payment_token: Address` to `StreamRequestExt`. This field is omitted from the PoC wire format and will be appended as a Tier 1 minor extension when multi-token support is implemented.
