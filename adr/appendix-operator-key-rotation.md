...
4. **Wait** the full unbonding period (default 14d per [ADR 030 §7](030-blake3-merkle-verification.md#7-interaction-with-stake-unbonding--unbondingperiod-raised-to-14-d), minimum 3d governable). Stake remains slashable in this window — do not relax monitoring.
