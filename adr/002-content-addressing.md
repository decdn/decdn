...
Publishers may encrypt content before upload, including with epoch keys. The protocol content-addresses and delivers only the resulting ciphertext, like any other blob. Key distribution is an application concern outside the protocol.
