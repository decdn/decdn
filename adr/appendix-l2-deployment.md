...
[ADR 026](026-gauge-boost-tokenomics.md#adr-026-gauge-boost-tokenomics) adds two gas-cost surfaces to re-validate
...
1. **`FeeRouter` per-settlement overhead.** Every `settleChannel` routes through
   ...
   [ADR 026 §7](026-gauge-boost-tokenomics.md#adr-026-gauge-boost-tokenomics).
...
2. **Per-epoch keeper-call gas economics.** Two TWAP-protected USDC→TOKEN swap
   ...
   delegator-pool flow per [ADR 026 §6](026-gauge-boost-tokenomics.md#adr-026-gauge-boost-tokenomics)) — at a
   ...
   bind at S2/S3 scale per [ADR 026 §8](026-gauge-boost-tokenomics.md#adr-026-gauge-boost-tokenomics)). Per-epoch keeper costs MUST be not cost-prohibitive at
