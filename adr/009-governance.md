...
Staking and slashing parameters are defined in [ADR 026 §7-§8](026-tokenomics.md#7-operator-economics-and-minimum-stake); fee-routing parameters are governed by [ADR 026 § Governable parameters with safety bounds](026-tokenomics.md#11-governable-parameters-with-safety-bounds). Payment channel parameters are defined in [ADR 003](003-payments.md#adr-003-payment-model). This ADR defines the governance mechanism that controls them.
