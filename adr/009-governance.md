...
- **Base slash reset period 30–365 days:** The base period (default 90 days) is multiplied by a hardcoded factor derived from lifetime offense count. A 30-day minimum prevents governance from making the reset trivially short (re-enabling gaming). A 365-day maximum prevents effectively permanent escalation, which would discourage staking.
