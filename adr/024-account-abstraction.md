...
- **Pool operations:** The EOA (or Safe) deposits USDC into `PaymentChannel.openChannel()`. That address is the pool `owner` — the funder — and `SignatureChecker` makes the choice transparent to every contract.
