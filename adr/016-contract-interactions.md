...
| `SignatureChecker` | StablePaymentChannel, PaymentChannel, StakingRegistry, SlashJudge | Unified EOA + ERC-1271 smart account signature verification ([ADR 023](023-account-abstraction.md)) |
