...
enum VoucherRejectReason {
    ...
    PoolExhausted,        // Pool's remaining deposit, minus the refundable floor M and already-committed concurrent floor credit, can no longer fund further credit for this stream — either pool-wide or within this signer's share of the pool's floor budget. Handler-emitted mid-stream after capability ownership is proven; no validation-enum counterpart
