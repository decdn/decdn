...
- **Purpose:** Signs vouchers (EIP-712), opens/closes payment channels (on-chain transactions), and signs ephemeral `BindNodeId` messages. Under v2.1 only operators bond TOKEN (via `CapacityBond`); clients have no bonding path.
