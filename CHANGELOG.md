...
<!-- Do not edit this file by hand. It is generated by git-cliff from the
     conventional-commit history during `cargo release` and overwritten on
     every release. Edits made here will be lost. To change an entry, amend
     the commit message; to change formatting, edit cliff.toml. -->
