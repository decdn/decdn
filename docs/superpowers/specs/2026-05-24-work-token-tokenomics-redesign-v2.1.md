...
**Supersedes (if adopted):** v2 spec (`2026-05-24-work-token-tokenomics-redesign-v2.md`), v1 spec (`2026-05-23-work-token-tokenomics-redesign-design.md`), ADRs 026, 034, 035. Substantial edits to 009 and 016. Minor edits to 003, 028, 032.
