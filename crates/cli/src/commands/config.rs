...
# get_logs_max_block_span = 10000    # max blocks per chain-watcher eth_getLogs request; set to your RPC provider's range limit (the poller also halves the window when the provider rejects a range); default 10000, must be > 0
