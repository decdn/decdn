...
async fn spawn_background_tasks<P: Provider + Clone + 'static>(
    ...
    let buyer_default_deposit = U256::from(cfg.blockchain.buyer_working_deposit_micro_usdc);
    ...
    let node_origin_config = crate::node_origin::NodeOriginConfig {
        ...
        deposit_hint: U256::from(cfg.blockchain.buyer_working_deposit_micro_usdc),
